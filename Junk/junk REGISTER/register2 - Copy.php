		...
		<script>
			...
			{					
				...
				var myemail = document.getElementById("email");				//LOOKS UP id="email"				
					...
					test(mycountry, "The COUNTRY box is not filled in correctly");					//TEST IF ONE PHONE# IS ENTERED
					var phones_status = true;
					if(
						test(myhphone, "The PHONE box is not filled in correctly") ||
						test(mybphone, "The PHONE box is not filled in correctly"))
						{
							console.log("Phone numbers PASSED")
							return phones_status = true;
						}
						else
						{
							console.log("Phone numbers FAILED")
							return phones_status = false;
						}
				...
				//TEST ALL VALIDATIONS BEFORE PASSING
				if(pcode_status && phones_status && final_status)
				{
					console.log("final validation: " + final_status);
